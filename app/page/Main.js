...
class Main extends Component {
    ...
    renderContent(pageText: any) {
        ...
        return (
            <View style={{ flex: 1, alignItems: 'center', backgroundColor: '#e56045',paddingTop: 20}}>
        ...
        移动端移动端移动端！！！！？？！！！@#！@#￥！@#￥！@￥移动端移动端移动端
            ...
            <View style={{width:414, height:200}}>
            <WebView
                bounces={true}
                scalesPageToFit={true}
                source={{uri:'https://www.youyong.ba'}}
                style={{
                    width: 414,
                    height: 0,
                }}
            ...
            <Button type="primary"  onClick={()=> this.goReduxPage()}> 
                {i18n.t('home.exit')}
            </Button>

            <Button type="ghost" size="small" onClick={()=> this.setLang('en')}>
            en
            </Button>

              <Button type="ghost" size="small"onClick={()=> this.setLang('zh')}>
                zh
              </Button>
        ...
        return (
            <TabBar
                  ...
                  >
                    ...
                    >
                        {this.renderContent('币币交易组件')}
                    </TabBar.Item>
                    <TabBar.Item
                      title="点对点交易"
                      selected={this.state.selectedTab === 'colorTab'}
                      onPress={() => this.onChangeTab('colorTab')}
                    >
                        {this.renderContent('点对点交易')}
                    </TabBar.Item>
                    <TabBar.Item
                      title="个人中心"
